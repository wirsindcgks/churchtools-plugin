...
final class DetailDesignTest extends TestCase
{
    ...
    {
        $order = ['description', 'media', 'share', 'ics', 'subscribe', 'title', 'calendar', 'location', 'time', 'date', 'subtitle'];
    ...
    public function testUpgradeOrderAppendsTheShareKeyToAnOrderStoredBeforeItExisted(): void
    {
        ...
        $this->assertSame(array_merge($stored, ['share', 'ics', 'subscribe']), $upgraded);
        $this->assertTrue(DetailDesign::isValidOrder($upgraded));
    }
    ...
    {
        $order = ['media', 'calendar', 'title', 'share', 'ics', 'subscribe', 'subtitle', 'date', 'time', 'location', 'description'];
